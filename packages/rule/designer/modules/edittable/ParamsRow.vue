 ...
 */
    import { paramColumns, paramColumnsList } from '../../config/node-config-ext.js'
    const datas = [];
    ...
    export default {
        ...
        data() {
            ...
            return {
                datas: this.currentSelect.params,
        ...
        methods: {
            ...
            save(key) {
                ...
                this.currentSelect.params = this.datas;
            },
            cancel(key) {
                // debugger
                // const newData = [...this.datas];
